...
class Configuracao(Base):
    ...
    codigo_configuracao_sistema = Literal[""]
    ...
    @classmethod
    def normalize_value(cls, codigo: codigo_configuracao_sistema, valor: str):
    ...
    @classmethod
    def get_configuracao(cls, codigo: codigo_configuracao_sistema):
